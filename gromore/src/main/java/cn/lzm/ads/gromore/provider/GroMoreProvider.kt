 ...
 */
open class GroMoreProvider : GroMoreProviderSplash() {
    ...
    override fun nativeAdIsBelongTheProvider(adObject: Any): Boolean {return true}
    ...
    override fun nativeExpressAdIsBelongTheProvider(adObject: Any): Boolean {return true}
    ...
    override fun nativeExpress2AdIsBelongTheProvider(adObject: Any): Boolean {return true}
}
