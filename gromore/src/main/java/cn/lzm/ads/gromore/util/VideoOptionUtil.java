package cn.lzm.ads.gromore.util;
...
public class VideoOptionUtil {
    ...
    public static TTVideoOption getTTVideoOption() {
        ...
        GDTExtraOption gdtExtraOption = new GDTExtraOption.Builder()
                .setGDTAutoPlayMuted(GroMoreProvider.FullVideo.INSTANCE.isMuted())//自动播放是否静音，默认true
                .setGDTDetailPageMuted(GroMoreProvider.FullVideo.INSTANCE.isMuted())//详情页是否静音，默认值为false，即有声播放；
        ...
        TTVideoOption videoOption = new TTVideoOption.Builder()
                .setMuted(GroMoreProvider.FullVideo.INSTANCE.isMuted()) //所有类型生效，GDT除外
